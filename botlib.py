...
#+---------------------------------------------+
#| Improved by Francesco OpenCode Apruzzese
#| Copyright (C) 2014
#| Website: www.e-ware.org
#| License: Public Domain
#+---------------------------------------------+
...
check_found = lambda s, k: (True if s.lower().find(k.lower()) > -1 else False)


def check_list_found(data, string_list):
    res = False
    for s in string_list:
        res = True if (res or check_found(data, s)) else False
    return res
